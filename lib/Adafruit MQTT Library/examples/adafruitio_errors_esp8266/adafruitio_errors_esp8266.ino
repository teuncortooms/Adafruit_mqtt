...
Adafruit_MQTT_Subscription onoffbutton = Adafruit_MQTT_Subscription(&mqtt, AIO_USERNAME "/feeds/onoff");

/*************************** Error Reporting *********************************/

Adafruit_MQTT_Subscription errors = Adafruit_MQTT_Subscription(&mqtt, AIO_USERNAME "/errors");
Adafruit_MQTT_Subscription throttle = Adafruit_MQTT_Subscription(&mqtt, AIO_USERNAME "/throttle");
